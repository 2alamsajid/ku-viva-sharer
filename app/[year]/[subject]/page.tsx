...
import AiSummaryDialog from '@/components/reusable/AiSummaryDialog';
...
export default async function VivaListPage({ params }: Props) {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#0B1416] text-[#D7DADC] px-4">
            <div className="flex flex-col items-center justify-between gap-4 py-4  max-w-3xl mx-auto w-full">
